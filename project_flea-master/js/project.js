...
// TODO !!!
// Bug Fixes/General Improvements - Test everything
// From Rubric!!! - Includes interactive tooltips, in at least one view, that are shown when users hover over marks. <-- Can we try adding hyperlinks or some sort of functionality to the tooltips on map or dots?
// Any easy adds?
// ^ When dots are selected, the related data point on the map will be shown. If deselected, the point on the map will be hidden. (WIP - Not implemented) <-- Are we combining this with filter idea to update map selection on filter button press instead?
// I'll work on the write up if you want to tackle these for now?
